  ...
  const items = () => [
    {
      ...
      context: 'defense',
      example: 'Enable the firewall. = Abilita il firewall.',
    },
    {
      english: 'Password',
      italian: "parola d'ordine",
      context: 'auth',
      example: 'Use a strong password. = Usa una password robusta.',
    },
    {
      english: 'Malware',
      italian: 'software malevolo',
      context: 'malware',
      example: 'Detect malware early. = Rileva il malware presto.',
    },
    {
      english: 'Exploit',
      italian: 'exploit',
      context: 'malware',
      example: "The exploit ran. = L'exploit e' partito.",
    },
    {
      english: 'Threat',
      italian: 'minaccia',
      context: 'general',
      example: "A new threat emerged. = Una nuova minaccia e' emersa.",
    },
  ];

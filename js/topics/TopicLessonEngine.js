...
const CONTEXT_INTROS = {
  ...
  'ai-engineering': {
    foundations: 'The building blocks of artificial intelligence. Understand AI, ML, and DL distinctions.',
    'machine-learning': 'Machine learning lets systems learn from data. Supervised, unsupervised, and more.',
    'deep-learning': 'Deep learning uses neural networks with many layers for complex pattern recognition.',
    nlp: 'Natural language processing bridges human language and machines. Tokenization, embeddings, and beyond.',
    'computer-vision': 'Computer vision teaches machines to see. Image classification, detection, and segmentation.',
    'data-engineering': 'Data engineering builds the pipelines that feed ML models. Feature stores and data lakes.',
    'model-training': 'Model training is where theory meets practice. Hyperparameters, loss functions, and optimization.',
    evaluation: 'Model evaluation tells you how well your AI actually performs. Metrics that matter.',
    deployment: 'Deploying AI models to production. Serving, optimization, and real-world constraints.',
    ethics: 'Responsible AI development. Bias, fairness, transparency, and societal impact.',
    tools: 'The frameworks and libraries that power modern AI. TensorFlow, PyTorch, and the ecosystem.',
    research: 'AI research pushes the boundaries. Benchmarks, SOTA, and the scientific method.',
    architectures: 'Advanced neural network architectures. Transformers, attention mechanisms, and beyond.',
    optimization: 'Making models faster and smaller. Quantization, pruning, and efficient inference.',
    mlops: 'MLOps brings DevOps practices to machine learning. Pipelines, registries, and reproducibility.',
  },
  'ethical-hacking': {
    methodology: 'Ethical hacking follows structured methodologies. Kill chains, frameworks, and standards.',
    reconnaissance: 'Reconnaissance is the first phase. Gathering information about targets before testing.',
    scanning: 'Scanning reveals the attack surface. Port scanning, enumeration, and vulnerability assessment.',
    exploitation: 'Exploitation turns vulnerabilities into access. Payloads, shells, and controlled attacks.',
    'post-exploitation': 'Post-exploitation happens after initial access. Escalation, persistence, and lateral movement.',
    'web-hacking': 'Web application hacking targets websites. Injection, XSS, and the OWASP Top 10.',
    'network-hacking': 'Network hacking targets infrastructure. Sniffing, spoofing, and man-in-the-middle attacks.',
    wireless: 'Wireless hacking targets Wi-Fi and radio. WPA cracking, rogue access points, and more.',
    'social-engineering': 'Social engineering exploits human psychology. Phishing, pretexting, and manipulation.',
    tools: 'The essential toolkit for ethical hackers. Metasploit, Burp Suite, Nmap, and more.',
    reporting: 'Reporting communicates findings to stakeholders. Severity ratings, PoCs, and recommendations.',
    legal: 'Legal and ethical boundaries of penetration testing. Authorization, disclosure, and compliance.',
    'mobile-hacking': 'Mobile security testing targets iOS and Android applications.',
    'cloud-hacking': 'Cloud penetration testing targets cloud infrastructure and misconfigurations.',
    hardware: 'Hardware hacking involves physical devices. Embedded systems, IoT, and hardware implants.',
  },
  'docker-k8s': {
    containers: 'Containers package applications with their dependencies. Lightweight, portable, and consistent.',
    images: 'Container images are blueprints. Layers, registries, and efficient builds.',
    'docker-cli': 'The Docker command line is your primary interface. Run, build, and manage containers.',
    dockerfile: 'Dockerfiles define how images are built. Instructions, layers, and best practices.',
    compose: 'Docker Compose orchestrates multi-container applications. Services, networks, and volumes.',
    ...
    registry: 'Container registries store and distribute images. Docker Hub, private registries, and CI/CD.',
    kubernetes: 'Kubernetes orchestrates containers at scale. Clusters, nodes, and the control plane.',
    pods: 'Pods are the smallest deployable units in Kubernetes. Containers, sidecars, and init containers.',
    services: 'Kubernetes services expose applications. ClusterIP, NodePort, LoadBalancer, and Ingress.',
    deployments: 'Deployments manage application lifecycle. Rolling updates, rollbacks, and scaling.',
    ...
    security: 'Container security protects the entire stack. Image scanning, RBAC, and pod security.',
    monitoring: 'Monitoring containers and clusters. Prometheus, health checks, and observability.',
  },
  'system-monitoring': {
    observability: 'Observability lets you understand system behavior. Metrics, logs, and traces together.',
    ...
    traces: 'Distributed tracing follows requests across services. Spans, context propagation, and visualization.',
    alerting: 'Alerting notifies you when things go wrong. Thresholds, notifications, and escalation.',
    dashboards: 'Dashboards visualize system health. Panels, queries, and real-time updates.',
    prometheus: 'Prometheus is the standard for metrics collection. Scraping, exporters, and PromQL.',
    ...
    automation: 'Automation reduces manual toil. Auto-remediation, runbooks, and self-healing systems.',
  },
  devsecops: {
    ...
    'container-security': 'Container security hardens images and runtimes. Scanning, signing, and least privilege.',
    ...
    'compliance-as-code': 'Compliance as code automates regulatory checks. Audit trails and policy enforcement.',
    'supply-chain': 'Supply chain security protects the software delivery pipeline. SBOM, provenance, and signing.',
    policy: 'Policy as code enforces security rules automatically. OPA, Rego, and admission control.',
    automation: 'Security automation reduces manual effort. SOAR, playbooks, and auto-remediation.',
    'cloud-security': 'Cloud security posture management. Misconfigurations, compliance, and runtime protection.',
    culture: 'DevSecOps culture makes security everyone\'s responsibility. Champions, training, and collaboration.',
    tools: 'The DevSecOps toolchain. Scanners, vaults, and policy engines integrated into CI/CD.',
  },
  'c-programming': {
    foundations: 'C is the foundation of systems programming. Variables, functions, and the main entry point.',
    syntax: 'C syntax is concise and powerful. Operators, control flow, and expressions.',
    types: 'C data types define how memory is interpreted. Integers, floats, chars, and type qualifiers.',
    pointers: 'Pointers are the heart of C. Memory addresses, dereferencing, and pointer arithmetic.',
    ...
    preprocessor: 'The C preprocessor runs before compilation. Macros, includes, and conditional compilation.',
    stdlib: 'The C standard library provides essential utilities. Memory, strings, math, and I/O.',
    algorithms: 'Implementing algorithms in C. Sorting, searching, and data structures from scratch.',
    ...
    embedded: 'Embedded C targets microcontrollers. Registers, interrupts, and hardware interaction.',
  },
  cpp: {
    foundations: 'C++ builds on C with object-oriented features. Classes, namespaces, and modern syntax.',
    ...
    templates: 'Templates enable generic programming. Type parameters, specialization, and metaprogramming.',
    memory: 'C++ memory management. Smart pointers, RAII, and move semantics.',
    'modern-cpp': 'Modern C++ (11/14/17/20) brings powerful new features. Auto, lambdas, and concepts.',
    ...
    metaprogramming: 'Template metaprogramming computes at compile time. Type traits and constexpr.',
  ...
  nodejs: {
    ...
    runtime: 'The Node.js runtime environment. Event-driven, non-blocking I/O, and single-threaded.',
    ...
    express: 'Express is the most popular Node.js web framework. Routes, middleware, and request handling.',
    api: 'Building APIs with Node.js. REST, controllers, and response formatting.',
    middleware: 'Middleware processes requests in sequence. Authentication, logging, and error handling.',
    ...
    events: 'The event system is core to Node.js. EventEmitter, listeners, and event-driven architecture.',
    deployment: 'Deploying Node.js applications. PM2, Docker, environment variables, and health checks.',
    performance: 'Node.js performance. Profiling, memory leaks, clustering, and caching.',
    typescript: 'TypeScript adds static typing to Node.js. Types, interfaces, and compiler configuration.',
  },
  rust: {
    ...
    structs: 'Rust structs define custom data types. Methods, associated functions, and derive macros.',
    enums: 'Rust enums are algebraic data types. Option, Result, and pattern matching.',
    traits: 'Traits define shared behavior. Trait bounds, default implementations, and polymorphism.',
    'error-handling': 'Rust\'s error handling is explicit. Result, Option, the ? operator, and panic.',
    generics: 'Generics enable code reuse. Type parameters, bounds, and monomorphization.',
    lifetimes: 'Lifetimes ensure references are valid. Annotations, elision, and the borrow checker.',
  ...
  'cloud-computing': {
    foundations: 'Cloud computing delivers IT resources on demand. IaaS, PaaS, SaaS, and deployment models.',
    ...
    serverless: 'Serverless computing. Functions, triggers, cold starts, and event-driven architecture.',
    ...
    architecture: 'Cloud architecture patterns. Well-Architected Framework, HA, and disaster recovery.',
  ...
  networking: {
    ...
    'osi-model': 'The OSI model has 7 layers. Understanding encapsulation and protocol interactions.',
    'tcp-ip': 'TCP/IP is the backbone of the internet. Connection-oriented and connectionless protocols.',
    protocols: 'Network protocols define communication rules. HTTP, DNS, SMTP, and application-layer services.',
    addressing: 'IP addressing and subnetting. IPv4, IPv6, CIDR notation, and DHCP.',
    routing: 'Routing directs traffic between networks. Routers, routing tables, and dynamic protocols.',
    ...
    troubleshooting: 'Network troubleshooting. Ping, traceroute, packet capture, and systematic diagnosis.',
    tools: 'Network tools and utilities. Diagnostic commands and protocol analyzers.',
    design: 'Network design. Three-tier architecture, spine-leaf, redundancy, and high availability.',
  ...
  databases: {
    ...
    nosql: 'NoSQL databases handle unstructured data. Document, key-value, graph, and column-family.',
    ...
    transactions: 'Transactions ensure data integrity. ACID properties, isolation levels, and locking.',
    optimization: 'Query optimization. Execution plans, EXPLAIN, and performance tuning.',
    replication: 'Database replication for high availability. Primary-replica, failover, and consistency.',
    administration: 'Database administration. Backups, user management, monitoring, and maintenance.',
    security: 'Database security. SQL injection prevention, encryption, auditing, and access control.',
    ...
    analytics: 'Database analytics. Time series, graph queries, ETL pipelines, and data warehousing.',
  },
  'git-vcs': {
    foundations: 'Git fundamentals. Repositories, commits, staging, and the working tree.',
    branching: 'Git branching enables parallel development. Creating, switching, and managing branches.',
    ...
    workflow: 'Git workflows. Git Flow, GitHub Flow, trunk-based development, and branching strategies.',
    advanced: 'Advanced Git operations. Worktrees, submodules, and filter-repo.',
    internals: 'Git internals. Objects, blobs, trees, commits, and the SHA-1 content-addressable store.',
    ...
    troubleshooting: 'Git troubleshooting. Recovering lost commits, fixing mistakes, and force push recovery.',
    monorepo: 'Monorepo strategies. Workspaces, sparse checkout, and build optimization.',
    strategy: 'Git strategy and governance. Repository organization, conventions, and team onboarding.',
  },
};
...
const TOPIC_FALLBACK_INTROS = {
  ...
  'ai-engineering': 'Master AI and machine learning terminology to navigate the world of artificial intelligence.',
  'ethical-hacking': 'Learn ethical hacking vocabulary to discuss penetration testing and offensive security.',
  'docker-k8s': 'Build your container and orchestration vocabulary with Docker and Kubernetes terms.',
  'system-monitoring': 'Learn observability and monitoring terms to discuss system health and reliability.',
  devsecops: 'Master DevSecOps terminology to integrate security into your development pipeline.',
  'c-programming': 'Learn C programming vocabulary to discuss systems programming and low-level concepts.',
  ...
  'cloud-computing': 'Master cloud computing vocabulary to discuss infrastructure and services in the cloud.',

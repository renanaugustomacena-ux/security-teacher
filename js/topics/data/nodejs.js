        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              phonetic: 'ap-DEIT',
              example:
                'A REST update sends PATCH /users/42 with a JSON body to change only the email field without touching other user attributes. = Un update REST invia PATCH /users/42 con un body JSON per cambiare solo il campo email senza toccare altri attributi utente.',
              context: 'api',
              difficulty: 'intermediate',
              code: 'PUT /users/:id',
            ...
            {
              english: 'Delete',
              italian: 'Endpoint REST Delete',
              pronunciation: '/dɪˈliːt/',
              phonetic: 'di-LIT',
              example:
                'A REST delete endpoint like DELETE /users/42 removes the user record and returns 204 No Content on success. = Un endpoint REST delete come DELETE /users/42 rimuove il record utente e restituisce 204 No Content in caso di successo.',
              context: 'api',
              difficulty: 'intermediate',
      ...
      lessons: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              english: 'Permissions',
              italian: 'Permessi di Autorizzazione',
              pronunciation: '/pərˈmɪʃənz/',
              phonetic: 'per-MIS-cions',
              example: `The middleware checks the authorization permissions on the JWT claims before letting the request hit the admin route handler. = Il middleware controlla i permessi di autorizzazione sui claim del JWT prima di lasciare arrivare la richiesta all'handler della route admin.`,
              context: 'middleware',
              difficulty: 'intermediate',
      ...
      lessons: [
        {
          ...
          items: [
            ...
            {
              english: 'Collection',
              italian: 'Collection MongoDB',
              pronunciation: '/kəˈlekʃən/',
              phonetic: 'kol-LEK-scen',
              example:
                'The MongoDB collection users stores one document per account and is indexed on the email field for fast login lookups. = La collection MongoDB users memorizza un documento per account ed è indicizzata sul campo email per lookup di login veloci.',
              context: 'database',
              difficulty: 'intermediate',
            ...
            {
              english: 'Schema',
              italian: 'Schema del Database',
              pronunciation: '/ˈskiːmə/',
              phonetic: 'SKI-ma',
              example: `The database schema for orders has a foreign key into customers and a partial index on status='paid' for reporting queries. = Lo schema del database per orders ha una foreign key verso customers e un indice parziale su status='paid' per query di reportistica.`,
              context: 'database',
              difficulty: 'intermediate',
      ...
      lessons: [
        ...
        },
        {
          ...
          items: [
            {
              english: 'try/catch',
              italian: 'try/catch a Runtime',
              pronunciation: '/traɪ kætʃ/',
              phonetic: 'TRAI-KEC',
              example: `A runtime try/catch around fs.readFileSync lets the request handler return a clean 404 when the configured file is missing on disk. = Un try/catch a runtime intorno a fs.readFileSync permette all'handler di richiesta di restituire un 404 pulito quando il file configurato è mancante su disco.`,
              context: 'runtime',
              difficulty: 'intermediate',
              code: 'try { } catch (e) { }',
            ...
            {
              english: 'finally',
              italian: 'Cleanup try/finally',
              pronunciation: '/ˈfaɪnəli/',
              phonetic: 'FAI-nal-li',
              example:
                'A try/finally cleanup block closes the open file descriptor whether the read succeeded or threw a permission error. = Un blocco di cleanup try/finally chiude il file descriptor aperto sia che la lettura sia riuscita o abbia lanciato un errore di permesso.',
              context: 'runtime',
              difficulty: 'intermediate',
        ...
        },
        {
          ...
          items: [
            ...
            {
              english: 'Status Code',
              italian: 'Status Code di Errore',
              pronunciation: '/ˈsteɪtəs koʊd/',
              phonetic: 'STEI-tus-KOUD',
              example: `An unhandled exception in the route handler is mapped to an error status code 500 so the client knows the request never succeeded. = Un'eccezione non gestita nell'handler di route è mappata a uno status code di errore 500 così il client sa che la richiesta non è mai riuscita.`,
              context: 'runtime',
              difficulty: 'intermediate',
              code: 'err.status = 404;',
      ...
      lessons: [
        {
          ...
          items: [
            ...
            {
              english: 'Encoding',
              italian: 'Encoding dello Stream',
              pronunciation: '/ɪnˈkoʊdɪŋ/',
              phonetic: 'in-KOUD-ing',
              example: `Calling stream.setEncoding('utf-8') sets the stream encoding so each data event delivers a string instead of a Buffer chunk. = Chiamare stream.setEncoding('utf-8') imposta lo stream encoding così ogni evento data consegna una stringa invece di un chunk Buffer.`,
              context: 'streams',
              difficulty: 'intermediate',
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              phonetic: 'ri-AK-tiv',
              example:
                'Reactive libraries like RxJS turn click and HTTP events into observable streams you can compose with map, filter, and debounce. = Le librerie reactive come RxJS trasformano eventi click e HTTP in stream osservabili che puoi comporre con map, filter e debounce.',
              context: 'events',
              difficulty: 'advanced',
              tool: 'RxJS',
            },
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              example: `Scaling Sockets across multiple Node processes usually means adopting the socket.io-redis adapter so events fan out cluster-wide. = Scalare i socket su più processi Node di solito significa adottare l'adapter socket.io-redis così gli eventi si diffondono in tutto il cluster.`,
              context: 'api',
              difficulty: 'advanced',
            },
          ],
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              example:
                'Constructor Injection is the preferred DI style in TypeScript because required dependencies become impossible to forget. = La constructor injection è lo stile DI preferito in TypeScript perché le dipendenze obbligatorie diventano impossibili da dimenticare.',
              context: 'foundations',
              difficulty: 'advanced',
      ...
      lessons: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              english: 'Memory Leak',
              italian: `Memory Leak nell'Heap`,
              pronunciation: '/ˈmeməri liːk/',
              phonetic: 'MEM-mo-ri-LIK',
              example: `A heap memory leak in the Node API showed up as steadily climbing rss in Grafana until PM2 restarted the worker after 8 hours. = Una memory leak nell'heap dell'API Node appariva come rss in costante salita su Grafana finché PM2 non riavviava il worker dopo 8 ore.`,
              context: 'performance',
              difficulty: 'advanced',
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              phonetic: 'TO-pik',
              example:
                'We split high-volume events across an orders topic and a low-priority audit topic so consumer lag stays bounded. = Suddividiamo gli eventi ad alto volume su un topic orders e un topic audit a bassa priorità così il lag dei consumer resta limitato.',
              context: 'api',
              difficulty: 'advanced',
      ...
      lessons: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              pronunciation: '/ˈhɔɪstɪŋ/',
              phonetic: 'OIST-ing',
              example: `Yarn hoisting pulls react up to the root node_modules so both the web app and the design system share a single copy. = L'hoisting di Yarn tira su react al node_modules di root così sia la web app sia il design system condividono una sola copia.`,
              context: 'foundations',
              difficulty: 'advanced',
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              example:
                'Semantic release reads conventional commits on main and decides whether the next tag is a patch, minor or major bump. = Semantic release legge i commit convenzionali su main e decide se il prossimo tag è un bump patch, minor o major.',
              context: 'foundations',
              difficulty: 'advanced',
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              pronunciation: '/ˈpaɪpˌlaɪn/',
              phonetic: 'PAIP-lain',
              example: `Our CI/CD pipeline lints, tests, builds the Docker image and rolls out to staging within 8 minutes on every merge to main. = La nostra pipeline CI/CD fa lint, test, build dell'immagine Docker e roll-out su staging entro 8 minuti ad ogni merge su main.`,
              context: 'foundations',
              difficulty: 'advanced',

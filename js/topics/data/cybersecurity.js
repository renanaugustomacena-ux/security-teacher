      ...
      lessons: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              taskEn:
                'Run the YARA rules recursively against the web document root to find known malware.',
            },
            {
              english: 'Firewall',
              ...
              taskEn:
                'Configure the firewall to deny incoming traffic by default, allowing only SSH.',
            },
            {
              english: 'Security',
              italian: 'Sicurezza',

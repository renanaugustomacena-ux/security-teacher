      ...
      turns: [
        {
          ...
          hintIt: 'Pensa alla metrica che misura quanti elementi segnalati sono realmente positivi.',
          onKeywordFound:
        ...
        },
        {
          ...
          hintIt: "C'e' una media armonica di precision e recall usata come singola metrica riassuntiva.",
          onKeywordFound:
        ...
        },
        {
          ...
          hintIt: 'Una tabella 2x2 che mostra veri/falsi positivi e negativi da un quadro completo.',
          onKeywordFound:
            "A {found} visualizes everything at once -- definitely include it.",
          onKeywordMissing:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          hintIt: 'Una piccola porzione di documento, dimensionata per stare nella finestra di contesto.',
          onKeywordFound:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          hintIt: "Quando la distribuzione di input al momento dell'inferenza diverge dai dati di training.",
          onKeywordFound:
      ...
      turns: [
        {
          ...
          onKeywordFound:
            "Exactly, each {found} is one input -- size, bedrooms, location, etc.",
          onKeywordMissing:
  ...
  'ethical-hacking': [
    {
      ...
      turns: [
        ...
        },
        {
          ...
          hintIt: 'La sezione del contratto che definisce target autorizzati, metodi e tempistiche.',
          onKeywordFound:
            "Exactly, the {found} is our shield. Outside it, we're just attackers.",
          onKeywordMissing:
      ...
      turns: [
        {
          ...
          hintIt: "Un'iniezione classica dove l'input dell'attaccante viene concatenato in una query del database.",
          onKeywordFound:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          hintIt: 'Meccanismi per sopravvivere ai reboot: scheduled task, registry run key, servizi.',
          onKeywordFound:
      ...
      turns: [
        {
          ...
          hintIt: 'Una valutazione numerica o etichettata come critical/high/medium/low, spesso via CVSS.',
          onKeywordFound:
        ...
        },
        {
          ...
          hintIt: "Una dimostrazione riproducibile che il bug esiste -- richieste, screenshot, codice.",
          onKeywordFound:
  ...
  'docker-k8s': [
    {
      ...
      turns: [
        ...
        },
        {
          ...
          onKeywordFound:
            "Yes, {found} with -p for ports and -e for env vars and you're up.",
          onKeywordMissing:
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, push to our private {found} so CI/CD can pull it during deploys.",
          onKeywordMissing:
            "Push to a {expected} -- Docker Hub, ECR, GHCR -- whichever you use.",
        },
      ],
      summary: {
      ...
      turns: [
        {
          ...
          onKeywordFound:
            "Right, {found} get pods and describe pod first to see events.",
          onKeywordMissing:
        ...
        },
        {
          ...
          onKeywordMissing:
            "Check the right {expected} -- workloads can be scoped with -n flag.",
        },
        {
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          hintIt: "Horizontal Pod Autoscaler -- regola il numero di repliche in base alle metriche.",
          onKeywordFound:
      ...
      turns: [
        {
          ...
          onKeywordFound:
            "Right, our {found} is 'p99 latency under 300ms'. Measurable and clear.",
          onKeywordMissing:
        ...
        },
        {
          ...
          onKeywordMissing:
            "It's {expected} -- the percentage of successful service over time.",
        },
        {
      ...
      turns: [
        {
          ...
          hintIt: 'Static Application Security Testing -- gira sul codice sorgente senza eseguirlo.',
          onKeywordFound:
        ...
        },
        {
          ...
          hintIt: 'Software Composition Analysis -- guarda alle librerie di terze parti per CVE note.',
          onKeywordFound:
            "Right, {found} flags vulnerable libraries against the CVE database.",
          onKeywordMissing:
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, the {found} fails the build if any High/Critical findings exist.",
          onKeywordMissing:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          onKeywordFound:
            "Yes, a {found} with gitleaks blocks commits containing secrets locally.",
          onKeywordMissing:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          hintIt: 'Un admission controller Kubernetes o policy OPA che blocca immagini non firmate.',
          onKeywordFound:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          hintIt: 'Uno sviluppatore embedded addestrato per gestire le preoccupazioni di sicurezza nel suo team.',
          onKeywordFound:
        ...
        },
        {
          ...
          hintIt: "Un esercizio strutturato per identificare e prioritizzare le minacce in anticipo.",
          onKeywordFound:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          onKeywordFound:
            "Yes, {found} with *p -- but be careful when p is NULL or freed.",
          onKeywordMissing:
            "You {expected} it -- write *p to read the value at that address.",
        },
        {
          ...
          onKeywordFound:
            "Right, the {found}-of operator & gives you that. Like int *p = &x;",
          onKeywordMissing:
            "Use the {expected}-of operator -- &x gives the address of variable x.",
        },
        {
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          hintIt: "Controllare che la lunghezza dell'input rimanga dentro la dimensione del buffer.",
          onKeywordFound:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          onKeywordMissing:
            "It's a {expected} file -- always with include guards or #pragma once.",
        },
        {
        ...
        },
        {
          ...
          hintIt: 'Le funzioni C restituiscono indicatori di errore che devono essere controllati manualmente.',
          onKeywordFound:
      ...
      turns: [
        {
          ...
          hintIt: "Resource Acquisition Is Initialization -- il pilastro della gestione moderna delle risorse C++.",
          onKeywordFound:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, an {found} -- temporaries and expiring values bound by T&&.",
          onKeywordMissing:
  ...
  nodejs: [
    {
      ...
      turns: [
        ...
        },
        {
          ...
          hintIt: "Un middleware a quattro argomenti (err, req, res, next) per gestione centralizzata.",
          onKeywordFound:
      ...
      turns: [
        {
          ...
          onKeywordFound:
            "Right, a {found} -- signed JSON we can verify without a session store.",
          onKeywordMissing:
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, in an {found} like JWT_SECRET. Never commit it to git.",
          onKeywordMissing:
      ...
      turns: [
        {
          ...
          onKeywordFound:
            "Right, {found}<T> -- the workhorse like std::vector in C++.",
          onKeywordMissing:
            "Use {expected}<T> -- the standard owned dynamic array.",
        },
        {
          ...
          onKeywordFound:
            "Right, {found} owns its bytes. Use &str for borrowed references.",
          onKeywordMissing:
            "Use {expected} for owned text -- &str for borrowed string slices.",
        },
        {
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, {found}<T> -- Some(x) or None. Way safer than null.",
          onKeywordMissing:
      ...
      turns: [
        {
          ...
          onKeywordFound:
            "Right, {found} -- multi-threaded executor with great ecosystem support.",
          onKeywordMissing:
      ...
      turns: [
        {
          ...
          onKeywordFound:
            "Right, an S3 {found} -- globally unique name, region-scoped storage.",
          onKeywordMissing:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, the {found} -- could be a user, role, or AWS service identity.",
          onKeywordMissing:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, {found} -- you manage the OS and up; the cloud handles hardware.",
          onKeywordMissing:
  ...
  networking: [
    {
      ...
      turns: [
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, the {found} record. AAAA is the IPv6 equivalent.",
          onKeywordMissing:
            "It's an {expected} record -- maps name to IPv4; AAAA does IPv6.",
        },
        {
          ...
          onKeywordFound:
            "Right, the {found} -- it walks the hierarchy and caches results.",
          onKeywordMissing:
      ...
      turns: [
        {
          ...
          onKeywordFound:
            "Right, {found} -- the suffix tells you how many bits are network.",
          onKeywordMissing:
        ...
        },
        {
          ...
          onKeywordMissing:
            "Carve out {expected}s -- typically /24 each, one per AZ per tier.",
        },
        {
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, a {found} -- in cloud it's a virtual router or transit gateway.",
          onKeywordMissing:
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, a BGP {found}ing -- TCP/179 session exchanging UPDATE messages.",
          onKeywordMissing:
      ...
      turns: [
        {
          ...
          onKeywordFound:
            "Right, {found} or tcpdump on the server -- save to pcap and analyze.",
          onKeywordMissing:
            "Use {expected} or tcpdump -- save a pcap file and dig in.",
        },
        {
          ...
          onKeywordFound:
            "Right, a {found} -- each one has headers per layer plus payload.",
          onKeywordMissing:
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, a display {found} -- crucial for huge captures.",
          onKeywordMissing:
      ...
      turns: [
        {
          ...
          onKeywordMissing:
            "We need {expected}s -- regular, automated, and verified periodically.",
        },
        {
      ...
      turns: [
        {
          ...
          onKeywordFound:
            "Right, a {found} -- creates a merge commit combining both lineages.",
          onKeywordMissing:
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, a feature {found} -- isolated work that gets merged back later.",
          onKeywordMissing:
            "On a {expected} -- a movable pointer; isolate work, then merge back.",
        },
        {
          ...
          onKeywordFound:
            "Right, git {found} the file -- then git commit to finalize the merge.",
          onKeywordMissing:
        ...
        },
        {
          ...
          onKeywordMissing:
            "Use git merge --{expected} -- safely returns to the pre-merge state.",
        },
      ],
      summary: {
    ...
    },
    {
      ...
      turns: [
        ...
        },
        {
          ...
          onKeywordFound:
            "Right, the {found} -- find its SHA in reflog and recover from there.",
          onKeywordMissing:
